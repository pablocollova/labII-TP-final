...
//printf("%c",'u');
    /*
//Nomenclatura para crear conexi�n con los puertos COM1 - COM9
Serial* Arduino = new Serial("COM7");
//Nomenclatura para crear conexi�n con los puertos COM10 en adelante
...
//Hacer el env�o indicando el buffer de salida y longitud
